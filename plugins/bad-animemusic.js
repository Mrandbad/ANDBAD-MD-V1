...
if (!text) return m.reply(`Enter a request`)
...
JT += `\n\n`
JT += `*No* : ${index + 1}\n`
JT += `*Title* : ${video.title}\n`
JT += `*Type* : ${video.type}\n`
JT += `*Artist* : ${video.artists}\n`
JT += `*Url* : ${video.url}\n`
})
...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  if (!text) return m.reply(`《★》Enter the name of a song.`);
...
handler.help = ['applemusicsearch *<text>*'];
handler.tags = ['search'];
