...
zokou({
  ...
  const _0x41d2b1 = {
    'externalAdReply': {
      'title': "ANDBAD-MD My Ultra Speed Response",
...
zokou({
  ...
  await _0x161605.sendMessage(_0x205206, {
    'text': "*𝐂.𝚵.𝚯 𝚫𝚴𝐃𝚩𝚫𝐃 UPTIME* " + _0x2f3abc,
    'contextInfo': _0xae590,
    'contacts': {
      'displayName': "ANDBAD Verified Contact",
      'contacts': [_0x297b69]
    },
    'quoted': _0x4e9ae0
  });
